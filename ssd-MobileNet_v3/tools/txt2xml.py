...
if __name__ == '__main__':
    root_path = r'C:\Users\ASUS\Desktop\intern\glovebox\start\datasets\mydata\images'
    txt_root = r'C:\Users\ASUS\Desktop\intern\glovebox\start\datasets\mydata\labels'
    gt_labels =['dangerous']
